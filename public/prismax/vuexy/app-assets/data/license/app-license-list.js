...
$(function () {
  ...
  var assetPath = '../prismax/vuexy/app-assets/',
    ...
    dtUserTable.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $name = full['license_key'],
              $email = full['company_name'],
              $image = full['avatar'];
            if ($image) {
              // For Avatar image
              var $output =
